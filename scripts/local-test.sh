...
test_all_workflows() {
    ...
    if test_workflow "publish-and-validate" "build-and-push" "push"; then
...
test_specific_service() {
    ...
    if test_workflow "publish-and-validate" "build-and-push" "workflow_dispatch"; then
...
Examples:
    ...
    $0 test-workflow publish-and-validate    # Test specific workflow
